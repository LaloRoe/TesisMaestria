...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{graficavanderpol.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=12cm]{vanderpol.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{poli_reyleigh.png}
	\caption{Grafico del polinomio promedio de $\eqref{eq: drvander}$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=12cm]{rayleigh.png}
	\caption{Plano fase de $\eqref{eq: drvander}$.}
\end{figure}
...
\begin{equation}\label{eq: n_0_m_3_equilibrio_positivo}
...
El siguiente sistema satisface las condiciones para tener dos puntos de equilibrio reales positivos:
...
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{r_doble_ciclo_limite.png}
	\caption{Grafico del polinomio promedio de $\eqref{eq: n_2_m_3_ejemplo_promedio}$.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=12cm]{doble_ciclo_limite.png}
